 ...
 *
 * The main.css purpose of this service is to simplify debugging and troubleshooting.
 *
 * @example
    <doc:example>
      <doc:source>
 ...
 *
 *  There are three main.css differences:
 *
 ...
 * `href` if the binding is present in the main.css application template (`index.html`) and you want to
 ...
 * including the rendered template of the current route into the main.css layout (`index.html`) file.
